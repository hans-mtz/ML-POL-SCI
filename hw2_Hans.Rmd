...
2. Estimate the best linear, additive model that you can - you can do this with one of the regularization tools if you like.
...
3. Using the tools from class - MARS, Polywog (if it doesn't take too long), CART, Random Forest and Gradient Boosted Machines - generate predictions for the training data.  Make sure to tune your models appropriately.
...
```
  ...
  - Which of the models does best on the training data (i.e., has the smallest residual sum of squares, or deviance)?
...
4. Use the trained models to estimate test set predictions
